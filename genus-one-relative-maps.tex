...
is an isomorphism. But $\HH^1(C_i,L)=0$ for $i \in \{1,\ldots,k\}$ since $C_i \cong \PP^1$ and $L|_{C_i}$ has non-negative degree, and by Serre duality
...
\Aaff^1_t & \,
\ecd
such that when we restrict to $0 \in \Aaff^1_t$ we get $C \to \PP^N$ and such that the general fibre is an element of the nice locus.
