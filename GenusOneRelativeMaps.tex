...
\subsection{Recursion formula for reduced rubber integrals} In the recursion above, certain terms appear which are integrals over moduli spaces of reduced log stable maps to rubber (as defined in \S \ref{}):
...
\begin{equation*} \VZ_{1,\alpha}(P|H_0+H_\infty)_{\Gm} \to \VZ_{1,n-1}(H). \end{equation*}
