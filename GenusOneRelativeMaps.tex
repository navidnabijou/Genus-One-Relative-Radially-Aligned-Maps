...
generated by $Q \times \N^k$ and $(\ol\varphi_{\eta_i}(1),u_{E_i}\cdot e_i,0)$ where $e_i \in \Z^r$ is the $i$th basis element and $0 \in \N^r$. In particular, $P$ admits an injective homomorphism into the group
