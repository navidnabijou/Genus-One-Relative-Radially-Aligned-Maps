...
\part{The recursion formula and applications} \noindent In this part we derive recursion relations on the moduli space of reduced stable maps (Theorem \ref{theorem recursion}). These are inspired by the constructions of Vakil and Gathmann, but go beyond these in several key respects, one of which is a full treatment of descendant invariants. We apply the recursions to produce a quantum Lefschetz algorithm in genus one, reconstructing the absolute theory of $Y$ and the relative theory of $(X,Y)$ from the absolute theory of $X$. Along the way we prove a splitting axiom for the reduced relative theory,  whose statement is nontrivial insofar as it involves the introduction of additional tautological classes.
