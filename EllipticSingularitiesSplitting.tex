...
\begin{equation*} \ol\Mcal_{1,\alpha}(\PP^N|H,d) \end{equation*}
...
\begin{remark} An important observation is that the subdivison $\Sigma_{1,\alpha}(\PP^N|H,d)$ of $\Sigma^{\operatorname{log}}$ is a further refinement of the subdivision $\Sigma^{\Kim}$ of $\Sigma^{\operatorname{log}}$. Thus we have a sequence of logarithmic modifications:
\begin{equation*} \widetilde\VZ_{1,\alpha}(\PP^N|H,d) \to \ol\Mcal_{1,\alpha}(\PP^N|H,d) \to \ol\Mcal^{\operatorname{log}}_{1,\alpha}(\PP^N|H,d).\end{equation*}
Consequently, we may view the moduli space of centrally aligned maps as a moduli space of maps to the expanded target. This point of view will be useful in what follows.\end{remark}
