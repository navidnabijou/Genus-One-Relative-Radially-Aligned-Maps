...
\subsection{Recursive description of the divisors: type $C^0$} In this case, the core has (horizontal) degree $0$ and is mapped into $H$. We start by describing the relevant combinatorial types of rays in $\widetilde{\VZ}_{1,\alpha}(\PP^N|H,d)$.
