...
\begin{equation*} f_*[Z]\cdot [Y]+\sum_{j=1}^r m_j\geq \sum_{x_i\in Z}\alpha_i \end{equation*}
...
Consider therefore the following ``object'' of $\VZc{1}{(5)}{\PP^2|\PP^1}{5}$, which \emph{does not} satisfy the novel condition:
