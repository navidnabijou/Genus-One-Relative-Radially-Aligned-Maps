...
Have to show that given a relative map, we can smooth it to one in the nice locus. This is done by considering different cases locally, then glueing.
...
Suppose furthermore that $C_0$ is an \emph{internal component}, meaning that it is mapped into $H$ via $f$, and that $C_1$,\ldots,$C_k$ are \emph{external components}, meaning that they are not mapped into $H$ via $f$. The picture is:
