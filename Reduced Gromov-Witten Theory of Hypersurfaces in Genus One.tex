...
with the centrally aligned rubber space:
\begin{equation*} \VZ^{\leftrightarrow}_{\Gamma_{\tiny{\sqC_0}}}(P|H_0+H_\infty).\end{equation*}
The factorisation condition here is accounting for the ``fibre-direction'' factorisation; the ``base-direction'' factorisation has not entered the picture yet, but will appear when we come to describe $\Dcal$.
...
We may use this to identify tangent spaces.
