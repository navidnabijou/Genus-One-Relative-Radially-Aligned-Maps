...
\begin{remark}
 ...
 \bcd
 \NN^2\oplus_{\NN} \pM_{S}\ar[r,"{(id,\cdot m_q)}"]\ar[d] & \NN^2\oplus_{\NN} \pM_{S}\ar[d] \\
 f^*\pM_W \ar[r,"f^\flat"]\ar[d] & \pM_C\ar[d] \\
 ...
 \ecd
 where the twist at $f(q)$ is given by $l$, that at $q$ is given by $r_q$, and the equality $l=r_qm_q$ has to hold.
\end{remark}
