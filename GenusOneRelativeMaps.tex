...
Since the map $\VZ \hookrightarrow \widetilde{\VZ}$ is strict, their Artin fans agree, so for the moment let us focus on $\widetilde{\VZ}$. We have a commutative square:
\bcd
...
This gives an affine-local description of the map $\Acal \to \Acal_\Mcal$ and in particular of the Artin fan $\Acal$. By the orbit-cone correspondence, the codimension-$k$ strata of $\Acal$ (locally) correspond to the $k$-dimensional cones in the polyhedral decomposition of $Q^\vee$. This is best understood through examples: we now present a number of these.
