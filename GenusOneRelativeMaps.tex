...
\begin{equation*} \Lcal_k = x_k^\st\pi^\st \Lcal_k = x_k^\st \OO_\Ccal(\alpha_k x_k) \otimes x_k^\st f^\st\OO(H) = x_k^\st \omega_{\Ccal/S} \otimes \ev_k^\st \OO(H) \end{equation*}
