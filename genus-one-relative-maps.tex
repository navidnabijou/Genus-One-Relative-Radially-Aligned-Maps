...
Note that this is well-defined by the fact that we have the factorisation $Q^{\operatorname{ctr}} \to \N$. The log structure on $\Ccal$ is obtained by pushing forward the log structure on the central fibre $C$. This completes step (2).
