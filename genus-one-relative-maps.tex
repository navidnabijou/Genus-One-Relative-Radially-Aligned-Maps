...
\section{Identifying the closure of the nice locus for $(\PP^N,H)$}
Recall \cite{RSPW} that the moduli space of maps from centrally aligned curves is obtained by first considering the Cartesian diagram
\bcd
...
\begin{dfn}
Fix a vector of tangency conditions $\alpha=(\alpha_1,\ldots,\alpha_n)$ with $\Sigma_i \alpha_i \leq Y \cdot \beta$. Then the \emph{centrally aligned relative space} 
