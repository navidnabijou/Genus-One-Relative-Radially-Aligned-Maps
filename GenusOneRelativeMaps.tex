...
Thus, the spaces of punctured maps we encounter are always birational to double ramification loci. We will now discuss the geometry of these loci. In the genus zero case, the double ramification locus is equal to the entire space
...
Thus we see that the double ramification locus can be quite badly-behaved in genus one. Fortunately, we will only be interested in the main component of this locus (which is birational to the main component of the moduli space of punctured maps); see \S \ref{} below.
...
\end{lem}
Note that the latter space (the main component of the moduli space of punctured maps) is birational to the main component of the double ramification locus. In Lemma \ref{Lemma forget marking} below we explain how to compute integrals over this.
\begin{proof}
